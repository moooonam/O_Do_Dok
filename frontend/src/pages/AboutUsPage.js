    ...
    <div className={aboutstyles["container"]}>
      ...
      <div className={aboutstyles["list"]}>
        ...
        <h2>오도독의 두 번째 기능</h2>
          <div className={aboutstyles["imgandinfo"]}>
            <div>
              <h3>모임원의 특성을 고려하여 도서를 추천받을 수 있어요</h3>
              <br />
              <p>
                모임원들의 성향을 종합하여 우리 모임만의 맞춤 도서를 빅데이터를 이용해 추천받을 수 있습니다.
              </p>
              <br />
              <p>
                또한, 도서에 대한 모임원들의 평가 데이터가 다시 추천 알고리즘에 반영되어 새로운 책을 추천받을 수 있어요.
              </p>
            </div>
            <img
        ...
        <div className={aboutstyles["four"]}>
          ...
          <div className={aboutstyles["imgandinfo"]}>
            ...
            <div>
              ...
              <br />
              <p>
                혹시, 도서를 끝까지 읽어야 한다는 부담감이 있진 않으신가요?
              </p>
              <br />
              <p>
                오도독에서는 도서를 끝까지 읽지 않아도 원하는 페이지에 리뷰를 남길 수 있습니다.
              </p>
            </div>
          </div>
        </div>
